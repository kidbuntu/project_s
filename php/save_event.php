...
$sql = "INSERT INTO event_header(event_name,event_category_id,event_description,fee,created_by,start_dt,status) VALUES('$event_name','$category_id','$event_desc','$fee','Admin','$start_dt','OPEN')";
